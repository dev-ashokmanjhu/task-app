        ...
        <div className="flex items-center p-4">
          <div className="relative flex flex-col items-center w-full">
            ...
            <div className="flex flex-col space-y-1 justify-center items-center -mt-12 w-full">
              ...
              <div className="py-2 flex space-x-2">
                <button
                  className="flex justify-center  max-h-max whitespace-nowrap focus:outline-none  focus:ring  focus:border-blue-300 rounded max-w-max border bg-transparent border-red-400 text-red-400 hover:border-red-800 hover:border-red-500 px-4 py-1 flex items-center hover:shadow-lg"
                ...
                <button
                  className="flex justify-center  max-h-max whitespace-nowrap focus:outline-none  focus:ring  focus:border-blue-300 rounded max-w-max text-gray-100 bg-red-500 hover:bg-red-600 px-4 py-1 flex items-center hover:shadow-lg"
